...
import InfoButton from './Button/InfoButton.jsx';
import PlayButton from './Button/PlayButton.jsx';
        ...
        <>
          ...
          <div className="Hero-banner-contents">
            ...
            <div className="Hero-banner-button">
              <PlayButton className="Hero_banner-play-button" onClick={() => {}} />
              <InfoButton className="Hero_banner-more-info-button" onClick={() => {}} />
            </div>
          </div>
